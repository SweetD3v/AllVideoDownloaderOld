...
fun Activity.setupDialogStuff(
    ...
    val backgroundColor = getColor(R.color.white)
...
//                isBlackAndWhiteTheme() -> resources.getDrawable(R.drawable.black_dialog_background, theme)
            ...
            window?.setLayout(realScreenSize.x - (realScreenSize.x * 20 / 100), WindowManager.LayoutParams.WRAP_CONTENT)
            callback?.invoke(this)
        }
    }
}
...
//    MaterialAlertDialogBuilder(this, R.style.MyProgressDialog)
//} else {
//    AlertDialog.Builder(this, R.style.MyProgressDialog)
//}
