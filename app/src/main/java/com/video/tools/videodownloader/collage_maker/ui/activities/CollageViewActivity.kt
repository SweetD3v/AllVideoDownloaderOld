...
import com.video.tools.videodownloader.collage_maker.features.college.CollegeUtils
import com.video.tools.videodownloader.collage_maker.features.college.PuzzleLayout
import com.video.tools.videodownloader.collage_maker.features.college.PuzzleLayoutParser
import com.video.tools.videodownloader.collage_maker.features.college.PuzzleView
import com.video.tools.videodownloader.collage_maker.features.college.adapter.PuzzleAdapter
import com.video.tools.videodownloader.collage_maker.ui.EditingToolType
import com.video.tools.videodownloader.collage_maker.ui.EditingToolType.*
import com.video.tools.videodownloader.collage_maker.ui.adapters.AspectRatioPreviewAdapter
import com.video.tools.videodownloader.collage_maker.ui.adapters.BottomToolsAdapter
import com.video.tools.videodownloader.collage_maker.ui.adapters.CollegeBGAdapter
import com.video.tools.videodownloader.collage_maker.ui.adapters.PieceToolsAdapter
import com.video.tools.videodownloader.collage_maker.ui.fragments.FilterDialogFragment
import com.video.tools.videodownloader.collage_maker.ui.fragments.PicsartCropDialogFragment
import com.video.tools.videodownloader.collage_maker.ui.interfaces.FilterListener
import com.video.tools.videodownloader.collage_maker.ui.interfaces.Sticker_interfce
import com.video.tools.videodownloader.collage_maker.utils.FileUtils.createBitmap
import com.video.tools.videodownloader.collage_maker.utils.FileUtils.saveBitmapAsFile
...
import com.video.tools.videodownloader.databinding.ActivityPuzzleBinding
...
import com.video.tools.videodownloader.ui.activities.MainActivity
...
class CollageViewActivity : FullScreenActivity(), BottomToolsAdapter.OnItemSelected,
    ...
    CollegeBGAdapter.BackgroundChangeListener,
    FilterListener,
    ...
    var piecePadding = 0f
    private val bottomSubToolsAdapter: PieceToolsAdapter =
        PieceToolsAdapter(
            this
        )
...
//            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val previewAspectRatioAdapter =
            AspectRatioPreviewAdapter()
        ...
        override fun doInBackground(vararg strArr: String?): Bitmap? {
            return try {
                ...
                val rotateBitmap: Bitmap = SystemUtils.rotateBitmap(
                    bitmap,
                    ExifInterface(contentResolver.openInputStream(fromFile)!!)
