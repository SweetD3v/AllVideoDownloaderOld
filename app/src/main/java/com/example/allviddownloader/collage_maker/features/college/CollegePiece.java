...
public class CollegePiece {
    ...
    CollegePiece(Drawable drawable2, Area area2, Matrix matrix2) {
    ...
    private void animateTranslate(final View view, final float f, final float f2) {
        ...
        this.animator.addUpdateListener(valueAnimator -> {
            CollegePiece.this.translate(f * ((Float) valueAnimator.getAnimatedValue()).floatValue(), f2 * ((Float) valueAnimator.getAnimatedValue()).floatValue());
            view.invalidate();
        });
    ...
    public void fillArea(View view, boolean z) {
        if (!isFilledArea()) {
            ...
            this.animator.addUpdateListener(valueAnimator -> {
                ...
                CollegePiece.this.zoom(f1, f1, pointF);
                CollegePiece.this.postTranslate(f21, f31);
                view2.invalidate();
            });
            if (z) {
