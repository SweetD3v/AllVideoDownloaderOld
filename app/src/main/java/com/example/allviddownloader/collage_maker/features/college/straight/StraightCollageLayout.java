...
public abstract class StraightCollageLayout implements CollageLayout {
    ...
    private ArrayList<CollageLayout.Step> steps = new ArrayList<>();
    ...
    protected StraightCollageLayout(StraightCollageLayout straightPuzzleLayout, boolean z) {
    ...
    public ArrayList<CollageLayout.Step> getSteps() {
        return this.steps;
    }
    ...
    public CollageLayout.Info generateInfo() {
        CollageLayout.Info info = new CollageLayout.Info();
        info.type = 0;
        info.padding = this.padding;
        info.radian = this.radian;
        info.color = this.color;
        info.steps = this.steps;
        ArrayList<CollageLayout.LineInfo> arrayList = new ArrayList<>();
        for (Line lineInfo : this.lines) {
            arrayList.add(new CollageLayout.LineInfo(lineInfo));
        }
